...
@synthesize barSpacingWidth;
@synthesize CustomBarWidth;
...
- (void)reloadDataAnimated:(BOOL)animated
{
	...
	dispatch_block_t createBarPaddingBlock = ^{
		...
		else
		{
			...
			self.barPadding = (1/(float)totalBars) * barSpacingWidth;
		}
	};
...
-(float)getBarSpacingWidth
{
    return barSpacingWidth;
}
#pragma mark - Setters
